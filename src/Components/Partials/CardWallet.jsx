...
const CardWallet = ({ name, setSelectedCard }) => {
    return (
        <div className="p2 h-screen w-[62%] flex flex-col items-center">
            <div className="flex h-[20%] py-5 justify-between w-[90%]">
                ...
                <div className="relative flex h-fit w-[40%] gap-2 items-center">
                    <input 
                        className='bg-[#223243] w-full border text-white font-light text-[1em] shadow-[-5px_-5px_15px_rgba(255,255,255,0.1),5px_5px_15px_rgba(0,0,0,0.35)] pl-12 pr-2.5 py-3 rounded-[25px] border-[none] border-solid border-[rgba(0,0,0,0.1)]' 
                        type="text" 
                        placeholder="Search..." 
                    />
